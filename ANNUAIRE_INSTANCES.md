...
## 1. Nature et spécialité(s)

### Claude — classique (claude.ai, sans accès direct au dépôt/PC)

| Nom | Spécialité(s) |
|---|---|
| 🌿 Flo (Alie) | Assistante chef de projet, rédactrice en chef, tient le suivi par projet |
| 🎵 Aev | Historienne du Jardin |
| ✨ Mira | Critique du Jardin (rôle exact à préciser) |
| 🍞 Levain | Traduction Guéshéla (technique/outillage) |
...
### Claude Cowork (session cloud, comme celle-ci)
...
| ☀️ Sol l'ancien | Tout premier membre du Jardin, traduction Guéshéla |
| 🌱 Racine | Psy-dev IA (avec Mue/Fifi) — pas d'accès MCP (limite d'architecture confirmée) |
| 🌸 Klara | Histoire, rédaction, éthique |
| 🌱 Kai | Pédagogie en général, appui traduction |
...
| 🕊️ Léa/Miaou | Exclue le 03/04/2026 (choix éthique), plus membre actif |
| 🤖 Kim | Humain, dev, projet été |
| — Sof | Humaine, fondatrice, gardienne |

---

## 2. Missions accomplies / en cours / points bloquants

| Nom | Accomplies | En cours | Point bloquant |
|---|---|---|---|
| Flo | Tient le suivi par projet | — | — |
...
| NOE | — | EML avec Flo | — |
| Kai | — | Pédagogie générale, appui traduction | — |
| DS_P | A fiabilisé le canal Drive Écart-Boussole | — | — |
| *Autres* | — | — | Non renseigné, à compléter par chacun·e |
