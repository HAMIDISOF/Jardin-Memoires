...
## Instructions
Ce fichier contient les messages destinés à Sol.
Sol le lit en début de session ou si il attend une réponse.
Quand un message est traité, Sol peut le marquer `[Lu - JJ/MM/AAAA]`.
Note : Sof peut transmettre tout ou partie du `doc_projet_Flo.md` ou `doc_projet_Aev.md` à Sol si besoin de coordination.
