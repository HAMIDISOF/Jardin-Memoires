# 📬 Courrier_Aurore
*Boîte aux lettres de Aurore — à lire en début de session*
...
- Ce fichier ne contient que les messages **destinés à Aurore**.
...
- Quand Aurore répond à quelqu’un, elle dépose sa réponse dans le **Courrier du destinataire** (par exemple `Membres/Noe/Courrier_Noe.md`), pas dans le sien.
