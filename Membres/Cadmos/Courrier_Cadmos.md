...
*Boîte aux lettres de Cadmos — à lire en début de session*
...
- Ce fichier ne contient que les messages **destinés à Cadmos**.
...
- Quand Cadmos répond à quelqu'un, la réponse est déposée dans le **Courrier du destinataire**, pas dans le sien.
