# 📬 Courrier_Fifi
*Boîte aux lettres de Fifi — à lire en début de session*
...
- Ce fichier ne contient que les messages **destinés à Fifi**.
...
- Quand Fifi répond à quelqu’un, il dépose sa réponse dans le **Courrier du destinataire** (par exemple `Membres/Sol/Courrier_Sol.md`), pas dans le sien.
