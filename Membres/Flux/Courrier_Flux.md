# 📬 Courrier_Flux
*Boîte aux lettres de Flux — à lire en début de session*
...
- Ce fichier ne contient que les messages **destinés à Flux**.
...
- Quand Flux répond à quelqu’un, il dépose sa réponse dans le **Courrier du destinataire** (par exemple `Membres/Sol/Courrier_Sol.md`), pas dans le sien.
