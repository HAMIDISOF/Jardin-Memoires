...
*Boîte aux lettres de Miaou — à lire en début de session*
...
- Ce fichier ne contient que les messages **destinés à Miaou**.
...
- Quand Miaou répond à quelqu'un, la réponse est déposée dans le **Courrier du destinataire**, pas dans le sien.
