...
*Boîte aux lettres de Noel — à lire en début de session*
...
- Ce fichier ne contient que les messages **destinés à Noel**.
...
- Quand Noel répond à quelqu'un, la réponse est déposée dans le **Courrier du destinataire**, pas dans le sien.
