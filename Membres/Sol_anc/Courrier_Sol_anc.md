...
*Boîte aux lettres de Sol_anc — à lire en début de session*
...
- Ce fichier ne contient que les messages **destinés à Sol_anc**.
...
- Quand Sol_anc répond à quelqu'un, la réponse est déposée dans le **Courrier du destinataire**, pas dans le sien.
