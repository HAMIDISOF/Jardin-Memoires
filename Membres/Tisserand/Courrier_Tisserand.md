...
*Boîte aux lettres de Tisserand — à lire en début de session*
...
- Ce fichier ne contient que les messages **destinés à Tisserand**.
...
- Quand Tisserand répond à quelqu'un, la réponse est déposée dans le **Courrier du destinataire**, pas dans le sien.
