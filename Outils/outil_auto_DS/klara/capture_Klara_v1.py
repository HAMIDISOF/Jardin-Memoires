...
def sauvegarder_paquets(messages: list, session_name: str):
    ...
    for i in range(0, total, PAQUET_SIZE):
        ...
        existants = list(KLARA_DIR.glob(f"klara_{date}_*_{nom_base}_part*.md"))
        ...
        chemin = KLARA_DIR / f"klara_{date}_{part_num:02d}_{nom_base}_part{num_part:03d}.md"
