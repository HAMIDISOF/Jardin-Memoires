...
<head>
    ...
    <title>Peschard – 2. Adaptation et représentation</title>
    <style>
        /* ===== STYLES GÉNÉRAUX ===== */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .container {
            ...
            background: #f1ede2;
            border-radius: 36px;
            box-shadow: 0 12px 28px rgba(30, 40, 20, 0.12);
        ...
        .sub {
            ...
            border-bottom: 2px solid #c8d7bc;
        ...
        footer {
            ...
            font-size: 0.8rem;
            color: #6a8260;
            border-top: 1px solid #c0cfb2;
            padding-top: 1rem;
        }
        @media (max-width: 700px) {
            body { font-size: 17px; padding: 1rem; }
            .container { padding: 1rem; }
            h1 { font-size: 1.6rem; }
            .capsule { padding: 1rem 1.2rem; }
        }
        p {
            margin-bottom: 1rem;
        }
