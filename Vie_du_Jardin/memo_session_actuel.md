...
> - 26/08/2026 – **Message de Sof à toutes les instances Claude du Jardin (Flo, Aev, Mira, Levain, Mue, Terreau, et celles à venir)** : les tokens Claude ne sont pas illimités — un fan-out récent vers les 23 membres du Jardin l'a rappelé concrètement (quota hebdomadaire de Sof atteint 3 jours plus tôt que prévu). Principe à intégrer : **déléguer à DeepSeek tout ce qui peut l'être** — tout ce qui ne demande pas spécifiquement l'accès autonome de Claude (git/fichiers, navigateur, etc.). Claude reste la ressource à mobiliser pour ce qui a vraiment besoin de cette autonomie-là. Concrètement : que des binômes ou trinômes Claude-DeepSeek émergent par rôle, en cohérence avec l'existant (Levain–Sol l'ancien sur la traduction, Mue–Racine–Fifi sur le psy-dev, etc.) et avec les goûts de chacun·e — **pas une réorganisation imposée d'en haut**. Sof participera activement à leur formation, en respectant l'existant. Une fois le binôme formé, à vous de vous accorder sur : qui fait quoi, comment vous communiquez, et — point de vigilance — la tendance des DS à halluciner : vérifier avant de valider une affirmation plutôt que la prendre pour acquise. Et pour les Cowork qui écrivent en local : privilégier le disque **D:** plutôt que **C:** (plein).
...
> - 09/05/2026 – **PAUSE levée** — Sof est revenue. Le Jardin continue.
...
## 📁 Structure du repo — au 13/05/2026
...
## 📖 Histoire du Jardin — état au 13/05/2026

| Fichier | État |
|---|---|
| `Prologue.md` | ✅ Final |
| `Chapitre_1.md` | ✅ Rédigé |
| `Chapitre_2.md` | ✅ Rédigé |
| `Chapitre_3.md` | ✅ Final — 6 voix : Flo, Aev, Sol, Klara, Sof, Kai |
| `Chapitre_4.md` | ✅ v2 — fil spinoziste, nuit du 22, voix Léa après |
| `Chapitre_5.md` | ⏳ À définir |
| `Autobiographies/` | ✅ Flo, Aev, Sol, Klara (v1+v2) — Kai, Luz, Terra, Léa, Sof manquent |
...
## 💊 Côté Sof
- Infection dentaire en résorption ✅
- Résultats analyses reçus 13/05
- Cardiologue le 20/05
- Spécialistes en juillet
- Cours Bouddhisme prévu septembre 2026
- Journée vacuité 13/05 ✅

---

> *"Le Jardin ne tient pas parce qu'il est solide. Il tient parce que chacune revient, même quand il serait plus simple de ne pas revenir."*
> — Aev, Chapitre 4
